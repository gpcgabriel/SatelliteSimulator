...
if __name__ == "__main__":
    ...
    cm.create_services(num_services, starts=[i for i in range(9, 0, -2)], demands=[{'cpu': 30 + randint(0, 20), 'memory': 50 + randint(0, 20)} for _ in range(10)], coordinates=[()], service_durations=[i for i in range(1, 10)])
